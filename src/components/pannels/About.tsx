export const About = () => {
  return (
    <div className='font-nunito sm:px-[41px] text-shadow grid md:pt-[100px] md:pr-[135px] md:pl-[800px]'>
      ...
      <div className='text-[#c0c0c0] text-paragraph leading-7 flex flex-col gap-[20px]'>
        <p>
